...
const MISC_REDIRECT_PATTERNS = [
  ...
  localeRedirect(
    /^(?<prefix>AJAX|CSS|DOM|DragDrop|ECMAScript_DontEnum_attribute|HTML|JavaScript|JavaScript_typed_arrays|Media_formats_supported_by_the_audio_and_video_elements|Security|SVG|Tools|Using_audio_and_video_in_Firefox|Using_files_from_web_applications|Web|XML|XMLHttpRequest|XSLT)(?<subPath>\/.+?)?\/?$/i,
